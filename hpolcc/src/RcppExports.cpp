...
RcppExport SEXP _hpolcc_get_ad_fun_raw_obs(SEXP modelSEXP, SEXP configSEXP, SEXP nameSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _hpolcc_get_ad_fun_raw_parameters(SEXP modelSEXP, SEXP configSEXP, SEXP nameSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type model(modelSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_hpolcc_get_ad_fun_raw_obs", (DL_FUNC) &_hpolcc_get_ad_fun_raw_obs, 3},
    {"_hpolcc_get_ad_fun_raw_parameters", (DL_FUNC) &_hpolcc_get_ad_fun_raw_parameters, 3},
    {NULL, NULL, 0}
};
