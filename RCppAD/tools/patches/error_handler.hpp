...
/*
  =============================================================================
  RCppAD R-safe patch of CppAD's error_handler.hpp
  =============================================================================

  ErrorHandler::Default uses REprintf + Rf_error instead of std::cerr +
  std::exit (Writing R Extensions, "Compiled code"). Reapplied by
  tools/update-cppad.sh on each upstream refresh.
