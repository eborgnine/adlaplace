...
(my_grad = adlaplace::grad(ad_fun, x, s_groups))
my_hess = adlaplace::hessian(ad_fun, x,  s_groups)
my_hess2 = aggregate(my_hess[,'value'], my_hess[,c("row","col")], sum)
my_hess3 = Matrix::sparseMatrix(i = my_hess2[,'row'], j = my_hess2[,'col'], 
  x = my_hess2[,'x'], index1=FALSE, symmetric=TRUE, dims = rep(length(x), 2))
```
