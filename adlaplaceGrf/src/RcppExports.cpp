...
RcppExport SEXP _adlaplaceGrf_create_ad_fun_random_fem_2(SEXP modelSEXP, SEXP configSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _adlaplaceGrf_create_ad_fun_random_fem_3(SEXP modelSEXP, SEXP configSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type model(modelSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_adlaplaceGrf_create_ad_fun_random_fem_2", (DL_FUNC) &_adlaplaceGrf_create_ad_fun_random_fem_2, 2},
    {"_adlaplaceGrf_create_ad_fun_random_fem_3", (DL_FUNC) &_adlaplaceGrf_create_ad_fun_random_fem_3, 2},
    {NULL, NULL, 0}
};
